...
- Run: `$ npx caliper launch manager --caliper-workspace ./ --caliper-networkconfig networkConfig.yaml --caliper-benchconfig benchmarks/testConfig.yaml  --caliper-fabric-gateway-enabled --caliper-flow-only-test`
