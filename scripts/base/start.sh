...
function startNetwork() {
    ...
    FABRIC_LOG=$logLevel COMPOSE_PROJECT_NAME=$PROJECT_NAME PROJECT_NAME=$PROJECT_NAME IMAGE_TAG=$FABRIC_VERSION NUM_ORGS=$orgNum NUM_PEERS=$peerNum docker-compose $coreServicesPath $peersServicesPath up -d 2>&1
    { set +x; } 2>/dev/null
