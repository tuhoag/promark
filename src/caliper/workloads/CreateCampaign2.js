...
class CreateCampaignWorkload extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        const {numPeersPerOrgs, numOrgsPerType, numVerifiersPerType, numDevices, numCampaigns} = this.roundArguments
    ...
    async submitTransaction() {
        ...
        // this.roundArguments
        let camId = `c${this.txIndex % this.roundArguments.numCampaigns}`

        const transArgs = {
            contractId: "campaign",
            contractFunction: 'GetCampaignById',
            contractArguments: [camId],
            // invokerIdentity: 'peer0.adv0.promark.com',
            // timeout: 300,
            readOnly: true
        };
